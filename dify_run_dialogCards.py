...
API_KEY = "app-sn9tgZPHYT6KAyviSe5mbBma" # 这是对话卡片的API密钥
CSV_FILE_PATH = "duolinguo_dialog_cards.csv"         # 确保这是你包含cid列的对话卡片任务CSV
OUTPUT_DIR = "results_test_dialogCards"
    ...
    for i, task in enumerate(tasks):
        ...
        payload = {
            "inputs": {
                ...
                "num_questions_type_10": task["num_questions_type_10"],
                "num_questions_type_11": task["num_questions_type_11"],
                "num_questions_type_12": task["num_questions_type_12"],
                "num_questions_type_13": task["num_questions_type_13"],
                "num_questions_type_14": task["num_questions_type_14"]
            },
